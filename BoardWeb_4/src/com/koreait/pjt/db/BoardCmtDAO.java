...
public class BoardCmtDAO 
{
	...
	{
		String sql = " INSERT INTO t_board4_cmt(i_cmt, i_board, i_user, cmt) SELECT seq_board4_cmt.nextval, ?, ?, ? FROM DUAL ";
	...
	{
		String sql = " update t_board4_cmt set m_dt = sysdate, cmt = ? where i_cmt = ? and i_user = ? ";
